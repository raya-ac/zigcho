...
- stable multiplayer rooms can start and finish a full round now; invites, tournament control, reconnect recovery, abort handling, and the real two-client run are still missing

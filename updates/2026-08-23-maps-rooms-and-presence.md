...
clicking one of those maps actually opens its page now too. the bss upload route was eating normal website requests because both use `/beatmapsets`, so public clicks and private PUT/PATCH uploads are separated properly now.
...
finished rooms still keep their scores and direct history page, but they are not shoved back into the live rooms list anymore. when everyone leaves a normal room or ranked match, it disappears from the website like it should.

...
Stable is still the production release lane. Lazer is moving one observed client contract at a time without changing Stable's already-closed behavior underneath it.
...
- lazer development is open again, but the production claim stays honest. login, trusted kai resources, official solo submission, exact modern-mod PP, and shared ranked stats now work in the isolated QA lane. rooms, durable event streams, multiplayer spectating, and a properly signed public client release still remain

...
const BeatmapArchiveDownload = sqlite_storage.Store.BeatmapArchiveDownload;
const ObjectMigrationStats = sqlite_storage.Store.ObjectMigrationStats;
const ObjectPurgeStats = sqlite_storage.Store.ObjectPurgeStats;

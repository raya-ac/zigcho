...
- the public site has live player profiles, vanilla/Relax/Autopilot rankings, recent Stable plays, and local map pages now. it still needs secure login, the BN review queue, appeals, staff workflows, and admin views hooked into the same PostgreSQL data

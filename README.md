...
- stable multiplayer rooms have slots, hosts, freemods, teams, passwords, chat, kicking, and cleanup; match start, load, score frames, failure, completion, skipping, invites, tournament control, and reconnect recovery are still missing

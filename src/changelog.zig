...
pub const latest_version = "2026.902.2";
...
pub const fallback_builds = [_]Build{
    .{ .id = 49, .version = "2026.902.2", .display_version = "zigcho release 2.3", .created_at = "2026-09-02T08:09:38+09:30", .updates = &.{
        .{ .name = "2026-09-02-client-and-harness-repos.md", .created_at = "2026-09-02T08:09:38+09:30", .commit = "", .markdown = @embedFile("../updates/2026-09-02-client-and-harness-repos.md") },
    } },
    .{ .id = 48, .version = "2026.902.1", .display_version = "zigcho release 2.2", .created_at = "2026-09-02T07:50:57+09:30", .updates = &.{
        .{ .name = "2026-09-02-zigcho-public-use-licence.md", .created_at = "2026-09-02T07:50:57+09:30", .commit = "", .markdown = @embedFile("../updates/2026-09-02-zigcho-public-use-licence.md") },
    } },
...
test "changelog exposes the complete checked in release history" {
    ...
    try std.testing.expectEqual(@as(usize, 25), object.get("builds").?.array.items.len);
    var entries: usize = 0;
    ...
    try std.testing.expectEqualStrings("the client and Stable harness have their own repos now", object.get("builds").?.array.items[0].object.get("changelog_entries").?.array.items[0].object.get("title").?.string);
    ...
    try std.testing.expectEqualStrings("2026.902.1", parsed_latest.value.object.get("versions").?.object.get("previous").?.object.get("version").?.string);

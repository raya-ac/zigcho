...
- stable multiplayer rooms can start and finish a full round, send invites, and feed supporter tournament viewers; referee/abort control and the real two-client run are still missing

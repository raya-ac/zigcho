...
Stable has not been disturbed by any of this. login, scores, PP, chat, multiplayer and spectating all passed again beside the lazer tests. the Windows client stays a portable alpha; there is no installer or signing job attached to it anymore because we do not need one.
